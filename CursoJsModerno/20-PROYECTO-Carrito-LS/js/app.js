// proyecto del carrito pero agregando localStorage
...
function cargarEventListeners() {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        actirulosCarrito = JSON.parse(localStorage.getItem('actirulosCarrito')) || []
...
function sincronizarStorage() {
    localStorage.setItem('actirulosCarrito', JSON.stringify(actirulosCarrito))
}
